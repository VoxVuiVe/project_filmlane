...
@WebServlet(urlPatterns = {"/admin", "/admin/favourites"}, name = "HomeControllerOfAdmin")

public class AdminController extends HttpServlet{

	private static final long serialVersionUID = -8004716199623374176L;
	...
	private void doGetFavourites(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
